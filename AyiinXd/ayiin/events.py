...
async def checking(client):
    ...
    checker = str(pybase64.b64decode("QFVwdXR0c3VwcG9ydA=="))[2:13]
    checkay = str(pybase64.b64decode("QGhpc3RvcnlidWJ1"))[2:15]
    checkaxs = str(pybase64.b64decode("QEthcmMwZGU="))[2:13]
    if client:
        try:
