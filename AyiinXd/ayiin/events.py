...
async def checking(client):
    gocheck = str(pybase64.b64decode("QG9oZ2l0dW5paA=="))[2:15]
    checker = str(pybase64.b64decode("QHVwdXR0c3VwcG9ydA=="))[2:17]
    checkay = str(pybase64.b64decode("QEhpc3RvcnlCdWJ1"))[2:15]
